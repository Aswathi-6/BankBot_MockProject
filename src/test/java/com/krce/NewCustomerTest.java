...
public class NewCustomerTest {
    ...
    public void createCustomerTest() {
        ...
        driver.findElement(By.name("addr")).sendKeys("249Perambalur");
        driver.findElement(By.name("city")).sendKeys("Trichy");
        ...
        driver.findElement(By.name("password")).sendKeys("Asha123");
    ...
    public void duplicateEmailTest() {
        ...
        driver.findElement(By.name("dob")).sendKeys("12-12-2011");
    ...
    public void successMessageTest() {
        ...
        driver.findElement(By.linkText("New Customer")).click();
        driver.findElement(By.name("name")).sendKeys("Abi");
        driver.findElement(By.xpath("//input[@value='f']")).click();
        driver.findElement(By.name("dob")).sendKeys("12-01-2005");
        driver.findElement(By.name("addr")).sendKeys("234Coimbatore");
        driver.findElement(By.name("city")).sendKeys("Coimbatore");
        driver.findElement(By.name("state")).sendKeys("Tamil Nadu");
        driver.findElement(By.name("pinno")).sendKeys("649901");
        driver.findElement(By.name("telephoneno")).sendKeys("2345678198");
        String email = "abi" + System.currentTimeMillis() + "@gmail.com";
        driver.findElement(By.name("emailid")).sendKeys(email);
        driver.findElement(By.name("password")).sendKeys("abi123");
        driver.findElement(By.name("sub")).click();
